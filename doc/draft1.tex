...
\begin{figure}[h]
    \begin{center}
        \includegraphics[scale=0.8]{images/gas_volume.pdf}
        \caption{Schematic setup for the barostat: The gas particles will be created on the face of the cube surrounding the crystal. The
                    cube is chosen to be at a distance of one side length of the nano crystal.}
        \label{fig:gascube}
    \end{center}
\end{figure}
