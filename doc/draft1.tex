...
use a visualisation and rendering software such as VMD\cite{Humphrey1996} or OVITO\cite{Stukowski2010}. The rendered image of the nano crystal can be
seen in fig.~\ref{fig:glass}.
\begin{figure}[h]
    \begin{center}
        \includegraphics[scale=0.2]{images/initial_position_red.png}
        \caption{}
        \label{fig:gascube}
    \end{center}
\end{figure}
