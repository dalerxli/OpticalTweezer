...
after the velocity Verlet has equilibrated the system. This means that the system is beginning to heat up, until the particles reach the crystal.
...
particles of that \textit{do} interact with the nano crystal shall be calculated.
