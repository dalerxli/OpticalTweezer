...
\end{itemize}
%\begin{itemize}
%\item Nanoteilchen $\rightarrow$ N Teilchen auf FCC Gitter, Lennard-Jones Wechselwirkung
%\item Energieaufnahme $\rightarrow$ eHEX Algorithmus
%\item Lokalisierung $\rightarrow$ Harmonisches Potential
%\item Umgebendes Gas $\rightarrow$ Thermostat mit idealem Gas
%\end{itemize}
\end{frame}
