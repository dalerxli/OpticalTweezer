...
plot "p0.1_at0.05/plotfile_clean.dat" using 1:2 smooth unique with linespoints pt 20 lw 25 lt rgb "red" notitle, \
    "p0.1_at0.1/plotfile_clean.dat" using 1:2 smooth unique  with linespoints pt 20 lw 25 lt rgb "blue" notitle
