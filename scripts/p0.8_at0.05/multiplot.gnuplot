...
plot "p0.8_at0.05_170206_1132_temperature_internal.dat" using ($0/1000.):1 w l lw 3 title "T_{int}",0.048 lw 6 lt rgb "blue" title "<T_{int}>";
unset output
set output "gastemp.pdf"
plot "p0.8_at0.05_170206_1132_gasTempData.dat" using ($0/1000.):2 w l lw 3 title "T_{em}",0.0494 lw 6 lt rgb "blue" title "<T_{em}>";
unset output
