...
plot "p1_at0.05/plotfile_clean.dat" using 1:2 smooth unique with linespoints pt 20 lw 25 lt rgb "red" title "T_{imp} = 0.05", \
    "p1_at0.1/plotfile_clean.dat" using 1:2 smooth unique with linespoints pt 20 lw 25 lt rgb "blue" title "T_{imp} = 0.1",\
