...
set output "p1_com.pdf"
plot "p1_at0.05/plotfile_clean.dat" using 1:2 smooth unique lw 4 lt rgb "red" title "T_{imp} = 0.05", \
    "p1_at0.1/plotfile_clean.dat" using 1:2 smooth unique lw 4 lt rgb "blue" title "T_{imp} = 0.1",\
