...
int main()
{
    ...
    FILE* tempout = fopen("ehex_temp_000_new_1_new.dat","w");
    FILE* enerout = fopen("ehex_energy_000_new_1_new.dat","w");
    FILE* compos = fopen("ehex_compos000_new_new.dat","w");
    FILE* comvel= fopen("ehex_comvel000_new_new.dat","w");
